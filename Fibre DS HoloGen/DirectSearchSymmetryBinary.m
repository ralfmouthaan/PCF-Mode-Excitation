...
function [RetVal] = DirectSearchSymmetryBinary(Illum, Target, ReplayMask)
    ...
    while IterNo < 3e6 %|| (maxglobalc < 0.04)
        ...
        % Random pixel position and random value
    ...
    RetVal.Holo = Holo;
    RetVal.Illum = Illum;
    RetVal.DiffractionField = Holo.*Illum;
    RetVal.Replay = fftshift(fft2(fftshift(RetVal.DiffractionField)));
